    ...
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="bg-white border-b border-gray-200 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-blue max-w-4xl text-gray-600 text-lg leading-relaxed whitespace-pre-wrap">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            {displayBuyingGuide && (
              <section>
                ...
                <div className="prose prose-blue max-w-none text-gray-600 bg-white p-8 rounded-2xl border border-gray-200 shadow-sm whitespace-pre-wrap">
                  {displayBuyingGuide}
                </div>
              </section>
            )}
