...
const toolData = getPdfToolData('png-to-pdf');
...
export async function generateMetadata({ searchParams }) {
  ...
  const slug = toolData.slug || 'png-to-pdf';
  return {
...
const ToolClientComponent = dynamic(() => import('../jpg-to-pdf/ImageToPdfClient'), {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        ...
        <ToolClientComponent toolSlug="png-to-pdf" acceptedExtensions={['.png']} accept="image/png" defaultFormatLabel="PNG" />

        {/* Educational SEO Content Section */}
        <PdfToolContentSection tool={localizedData} lang={lang} />

        {/* Related PDF Utilities */}
        <PdfRelatedTools currentSlug="png-to-pdf"  lang={lang} />
      </div>
    </>
  );
}
