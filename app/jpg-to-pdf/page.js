...
const toolData = getPdfToolData('jpg-to-pdf');
...
export async function generateMetadata({ searchParams }) {
  ...
  const slug = toolData.slug || 'jpg-to-pdf';
  return {
...
const ToolClientComponent = dynamic(() => import('./ImageToPdfClient'), {
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 md:py-12 max-w-4xl">
        ...
        <PdfRelatedTools currentSlug="jpg-to-pdf"  lang={lang} />
      </div>
    </>
  );
}
