...
async function seedTranslations() {
  ...
  try {
    ...
    console.log(`Found ${tools.length} tools. Seeding translations...`);
    
    for (const tool of tools) {
      // Create some verified, rich translations for Spanish and French
      ...
      console.log(`✅ Updated translations for: ${tool.name}`);
    }
